...
class Layout {
    ...
    private $CI;
    private $var = array();
    //theme est l' attribut  pour stocker le nom  du layout  que l ' on veut  charger
...
//         
        //on specifie à la vue de prendre en compte  e bon layout 
...
public function ajouter_css($nom) {
    ...
    public function ajouter_js($nom) {
      ...
      /*
 |============================================================================
 |une m ét hode pour modifier le nom  du  layout par defaut. 
 | On fait ensuite une vérification de l ' existence du fichier
 |============================================================================
     */
